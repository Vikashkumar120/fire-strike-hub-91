    ...
    <div className="min-h-screen bg-gradient-to-br from-slate-900 via-purple-900 to-slate-900 flex items-center justify-center p-4">
      ...
      <div className="relative z-10 w-full max-w-md mx-auto">
        ...
        <div className="text-center mb-6 md:mb-8">
          ...
          <p className="text-gray-300 text-sm md:text-base px-4">Enter your credentials to access your account</p>
        </div>

        <Card className="bg-black/30 backdrop-blur-md border border-gray-700 mx-4 md:mx-0">
          <CardHeader className="pb-4">
            <CardTitle className="text-white text-center text-lg md:text-xl">Sign In</CardTitle>
          </CardHeader>
