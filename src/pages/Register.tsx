    ...
    <div className="min-h-screen bg-gradient-to-br from-slate-900 via-purple-900 to-slate-900 flex items-center justify-center p-4">
      ...
      <div className="relative z-10 w-full max-w-md mx-auto">
        ...
        <div className="text-center mb-6 md:mb-8">
          ...
          <h1 className="text-2xl md:text-3xl font-bold text-white mb-2">Join the Arena</h1>
          <p className="text-gray-300 text-sm md:text-base px-4">Create your account and start competing</p>
        </div>

        <Card className="bg-black/30 backdrop-blur-md border border-gray-700 mx-4 md:mx-0">
          <CardHeader className="pb-4">
            <CardTitle className="text-white text-center text-lg md:text-xl">Create Account</CardTitle>
          </CardHeader>
            ...
            <form onSubmit={handleSubmit} className="space-y-4">
              ...
              <div className="flex items-start space-x-3">
                <input
                  type="checkbox"
                  id="terms"
                  className="mt-1 rounded border-gray-600 bg-black/20"
                  required
                />
                <label htmlFor="terms" className="text-gray-300 text-xs md:text-sm">
                  I agree to the{' '}
